...
# %% [markdown]
# Go to https://api.github.com/repos/apache/hadoop/contributors. 
...
# %% [markdown]
# Write code that creates an SQL database + table, and stores all the information obtained in it.  Please be cautious of the data type you choose for each column and briefly justify your decisions.  What do you choose as Primary Key and why?
# 
...
# %% [markdown]
# Optimize the code to allow for quick look-ups of "login", "location", and "hireable".  What choices do you make and why?
# 
